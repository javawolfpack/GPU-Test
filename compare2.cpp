...
// BENCHMARK(BM_mspkadane)->DenseRange(0, 16384, 128);
// BENCHMARK(BM_mspDC)->DenseRange(0, 16384, 128);
// BENCHMARK(BM_mspnaive)->DenseRange(0, 16384, 128);
BENCHMARK(BM_mspkadane)->RangeMultiplier(2)->Range(8, 16<<10);
BENCHMARK(BM_mspDC)->RangeMultiplier(2)->Range(8, 16<<10);
BENCHMARK(BM_mspnaive)->RangeMultiplier(2)->Range(8, 16<<10);
// Run the benchmark
BENCHMARK_MAIN();
